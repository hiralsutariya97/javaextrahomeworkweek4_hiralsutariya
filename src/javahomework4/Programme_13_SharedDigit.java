...
public class Programme_13_SharedDigit {
    public static boolean hasShareDigit(int firstNumber, int secondNumber) {
        if ((firstNumber >= 10 && firstNumber <= 99) && (secondNumber <= 99)) {
            int firstNummberLastDigit = firstNumber % 10;
            ...
            return ((firstNumberFirstDigit == secondNumberFirstDigit) ||
                    ...
                    (firstNummberLastDigit == secondNumberFirstDigit) ||
                    (firstNummberLastDigit == secondNumberLastDigit));
        }
        return false;
    }
